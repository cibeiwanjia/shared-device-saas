...
type Data struct {
	...
	UserClient    *Data_UserClient       `protobuf:"bytes,5,opt,name=user_client,json=userClient,proto3" json:"user_client,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type Data_Redis struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Addr          string                 `protobuf:"bytes,1,opt,name=addr,proto3" json:"addr,omitempty"`         // Redis 地址
...
type Data_UserClient struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Endpoint      string                 `protobuf:"bytes,1,opt,name=endpoint,proto3" json:"endpoint,omitempty"` // User服务gRPC地址
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Data_UserClient) GetEndpoint() string {
	if x != nil {
		return x.Endpoint
	}
	return ""
...
const file_internal_conf_conf_proto_rawDesc = "" +
	...
	"\anetwork\x18\x01 \x01(\tR\anetwork\x12\x12\n" +
	"\x04addr\x18\x02 \x01(\tR\x04addr\x123\n" +
	"\atimeout\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\atimeout\"\xe2\x06\n" +
	"\x04Data\x125\n" +
	...
	"\vuser_client\x18\x05 \x01(\v2\x1b.kratos.api.Data.UserClientR\n" +
	"userClient\x1a:\n" +
	"\bDatabase\x12\x16\n" +
	...
	"\x0erefresh_expiry\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\rrefreshExpiry\x1a(\n" +
	"\n" +
	"UserClient\x12\x1a\n" +
	"\bendpoint\x18\x01 \x01(\tR\bendpointB3Z1shared-device-saas/app/storage/internal/conf;confb\x06proto3"
...
var file_internal_conf_conf_proto_goTypes = []any{
	...
	(*Data_UserClient)(nil),     // 9: kratos.api.Data.UserClient
...
var file_internal_conf_conf_proto_depIdxs = []int32{
	...
	9,  // 8: kratos.api.Data.user_client:type_name -> kratos.api.Data.UserClient
