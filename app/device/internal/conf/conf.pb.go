...
type Data struct {
	...
	Jwt           *Data_JWT              `protobuf:"bytes,5,opt,name=jwt,proto3" json:"jwt,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type Data_MQTT struct {
	...
	CleanStart        bool                   `protobuf:"varint,7,opt,name=clean_start,json=cleanStart,proto3" json:"clean_start,omitempty"`
	SessionExpiry     uint32                 `protobuf:"varint,8,opt,name=session_expiry,json=sessionExpiry,proto3" json:"session_expiry,omitempty"`
	MaxReconnectDelay uint32                 `protobuf:"varint,9,opt,name=max_reconnect_delay,json=maxReconnectDelay,proto3" json:"max_reconnect_delay,omitempty"`
	PublishTimeout    uint32                 `protobuf:"varint,10,opt,name=publish_timeout,json=publishTimeout,proto3" json:"publish_timeout,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *Data_MQTT) GetPort() int32 {
	if x != nil {
		return x.Port
	}
	return 0
...
func (x *Data_MQTT) GetKeepalive() uint32 {
	if x != nil {
		return x.Keepalive
	}
	return 0
...
func (x *Data_MQTT) GetCleanStart() bool {
	if x != nil {
		return x.CleanStart
	}
	return false
...
func (x *Data_MQTT) GetSessionExpiry() uint32 {
	if x != nil {
...
func (x *Data_MQTT) GetMaxReconnectDelay() uint32 {
	if x != nil {
		return x.MaxReconnectDelay
	}
	return 0
}

func (x *Data_MQTT) GetPublishTimeout() uint32 {
	if x != nil {
...
const file_conf_proto_rawDesc = "" +
	...
	"\anetwork\x18\x01 \x01(\tR\anetwork\x12\x12\n" +
	"\x04addr\x18\x02 \x01(\tR\x04addr\x123\n" +
	"\atimeout\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\atimeout\"\xc2\t\n" +
	"\x04Data\x125\n" +
	...
	"\x04mqtt\x18\x04 \x01(\v2\x15.kratos.api.Data.MQTTR\x04mqtt\x12&\n" +
	"\x03jwt\x18\x05 \x01(\v2\x14.kratos.api.Data.JWTR\x03jwt\x1a:\n" +
	"\bDatabase\x12\x16\n" +
	...
	"\rwrite_timeout\x18\x06 \x01(\v2\x19.google.protobuf.DurationR\fwriteTimeout\x1a\x90\x01\n" +
	"\aMongoDB\x12\x10\n" +
	...
	"authSource\x1a\xc6\x02\n" +
	"\x04MQTT\x12\x16\n" +
	"\x06broker\x18\x01 \x01(\tR\x06broker\x12\x12\n" +
	...
	"\tkeepalive\x18\x06 \x01(\rR\tkeepalive\x12\x1f\n" +
	"\vclean_start\x18\a \x01(\bR\n" +
	"cleanStart\x12%\n" +
	"\x0esession_expiry\x18\b \x01(\rR\rsessionExpiry\x12.\n" +
	"\x13max_reconnect_delay\x18\t \x01(\rR\x11maxReconnectDelay\x12'\n" +
	"\x0fpublish_timeout\x18\n" +
	" \x01(\rR\x0epublishTimeout\x1a\xd3\x01\n" +
	"\x03JWT\x12#\n" +
	...
	"\x0erefresh_expiry\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\rrefreshExpiryB2Z0shared-device-saas/app/device/internal/conf;confb\x06proto3"
...
var file_conf_proto_goTypes = []any{
	...
	(*Data_MQTT)(nil),           // 8: kratos.api.Data.MQTT
...
var file_conf_proto_depIdxs = []int32{
	...
	8,  // 7: kratos.api.Data.mqtt:type_name -> kratos.api.Data.MQTT
